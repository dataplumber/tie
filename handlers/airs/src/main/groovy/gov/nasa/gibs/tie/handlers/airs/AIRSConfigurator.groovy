...
/**
 * Implementation os AIRS configurator
 *
 * @author T. Huang
 * @version $Id: $
 */
...
public class AIRSConfigurator extends ApplicationConfigurator {

   private static Log logger = LogFactory.getLog(AIRSConfigurator.class)
   ...
   public AIRSConfigurator(String[] args) {
      this.args = args
