...
/**
 * Implementation of the gov.nasa.gibs.tie.handlers.amsr2.AMSR2 data crawler
 *
 * @author T. Huang
 * @version $Id: $
 */
class AMSR2DataCrawler extends TimerTask {

   private static Log log = LogFactory.getLog(gov.nasa.gibs.tie.handlers.amsr2.AMSR2DataCrawler.class)
    ...
    */
   public AMSR2DataCrawler() {
      this.manager.start()
   }

   public AMSR2DataCrawler(gov.nasa.gibs.tie.handlers.amsr2.AMSR2ProductType productType,
