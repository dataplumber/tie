 ...
 * @version $Id: $
 */
class CMRFileHandler implements FileHandler {

	private static Log logger = LogFactory.getLog(CMRFileHandler.class)
	...
	public CMRFileHandler(CMRProductType productType) {
    ...
    private LocalFileProduct generateGeo(String path) {
        ...
        File geoFile
        if(this.productType.left_lon != null && this.productType.right_lon && this.productType.upper_lat && this.productType.lower_lat) { 
            geoFile = new File(path)
            
            Float geoLine1 = (this.productType.right_lon - this.productType.left_lon) / this.productType.width
            Float geoLine4 = (this.productType.upper_lat - this.productType.lower_lat) / (this.productType.height * -1)
            Float geoLine5 = this.productType.left_lon + (geoLine1 / 2)
            Float geoLine6 = this.productType.upper_lat + (geoLine4 / 2)
