...
import gov.nasa.gibs.tie.handlers.cmr.CMRConfigurator;
 ...
 */
public class CMRProductTypeTest extends GroovyTestCase {
   private static Log logger = LogFactory.getLog(CMRProductTypeTest.class)

   public void testSimple() {
      String[] args = ['-p', 'MORCR721LLDY', '-s', '2013-08-28']
      ApplicationConfigurator configurator = new CMRConfigurator(args)
