...
/**
 * Implementation os MLS configurator
 *
 * @author T. Huang
 * @version $Id: $
 */
...
public class MLSConfigurator extends ApplicationConfigurator {

   private static Log logger = LogFactory.getLog(MLSConfigurator.class)
   ...
   public MLSConfigurator(String[] args) {
      this.args = args
