 ...
 */
class MLSWalkerThreadTest extends GroovyTestCase {

   private static Log logger = LogFactory.getLog(MLSWalkerThreadTest.class)

   public void testWalkerThread() {
      String[] args = ['-s', '2014-08-22', '-e', '2014-08-22']
      ApplicationConfigurator configurator = new MLSConfigurator(args)
      assertFalse(configurator.hasError())
      Map<String, ProductType> pts = configurator.productTypes
      assertEquals(14, pts.size())
