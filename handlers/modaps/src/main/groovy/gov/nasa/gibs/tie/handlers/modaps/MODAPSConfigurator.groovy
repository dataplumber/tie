...
/**
 * Implementation os MODAPS configurator
 *
 * @author T. Huang
 * @version $Id: $
 */
...
public class MODAPSConfigurator extends ApplicationConfigurator {

   private static Log logger = LogFactory.getLog(MODAPSConfigurator.class)
   ...
   public MODAPSConfigurator(String[] args) {
      this.args = args
