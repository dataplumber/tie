...
/**
 * Implementation os OMI configurator
 *
 * @author T. Huang
 * @version $Id: $
 */
...
public class OMIConfigurator extends ApplicationConfigurator {

   private static Log logger = LogFactory.getLog(OMIConfigurator.class)
   ...
   public OMIConfigurator(String[] args) {
      this.args = args
