 ...
 */
class SFTPWalkerThreadTest extends GroovyTestCase {

   private static Log logger = LogFactory.getLog(gov.nasa.gibs.tie.handlers.sftp.SFTPWalkerThreadTest.class)
